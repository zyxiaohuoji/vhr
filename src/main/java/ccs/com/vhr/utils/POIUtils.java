...
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //文档管理员
        docInfo.setManager("zyAdmin");
        //设置公司信息
        docInfo.setCompany("ccssoft");
        //4. 获取文档摘要信息
    ...
    public static List<Employee> excel2Employee(MultipartFile file,
                                                ...
                                                List<Department> allDepartmentsWithOutChildren,
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 11:
                                        ...
                                        break;
                                    case 12:
                                        int departmentIndex = allDepartmentsWithOutChildren.indexOf(new Department(cellValue));
                                        employee.setDepartmentId(allDepartmentsWithOutChildren.get(departmentIndex).getId());
                                        break;
                                    case 13:
